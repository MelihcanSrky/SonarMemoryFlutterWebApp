    ...
    return Observer(builder: (_) {
      return AlignedGridView.count(
        ...
        itemBuilder: (context, index) {
          final sm1Branches = store
              .projectNBranchesVM.sm1ProjectsNBranches?[index].projectBranches;
          final isProjectExist = store.projectNBranchesVM.sm2ProjectsNBranches!
              .map((e) => e.uuid)
              .contains(
            ...
            onTap: () {
              ...
              if (isProjectExist && isBranchExist) {
                ...
                Get.offNamed(Applinks.DASHBOARD, arguments: {
                  "projectUuid": store.projectNBranchesVM.sm2ProjectsNBranches!
                      .where((element) =>
                          element.uuid ==
                ...
                Get.toNamed(Applinks.NEW_PROJECT, arguments: {
                  ...
                  "uuid": store
                      .projectNBranchesVM.sm1ProjectsNBranches?[index].uuid,
                  "projectKee":
                      store.projectNBranchesVM.sm1ProjectsNBranches![index].kee,
                  "branchKee": store.projectNBranchesVM
                      .sm1ProjectsNBranches![index].projectBranches?.first.kee,
                })!
                    .then((value) {
                  store.projectNBranchesVM.getProjectsNBranches();
                });
            ...
            child: Card(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          const EdgeInsets.symmetric(vertical: Dimens.margin_8),
                      child: Text(
                        store.projectNBranchesVM.sm1ProjectsNBranches?[index]
                                .name ??
                            Strings.noName,
                        style: TextStyle(
                            fontSize: projectCardTheme.titleTextStyle!.fontSize,
                            fontWeight:
